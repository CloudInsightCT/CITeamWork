		...
		<div class="modal-dialog modal-sm">
    		<div class="modal-content">
				...
				<div class="modal-body">
					<p align="center">加载中，请耐心等待...</p>
					<p align="center"><img src="img/loading.gif"></p>
				</div>
    		</div>
  		</div>
	</div>
...
<script src="js/bootstrap.min.js"></script>
 ...
 // var  tootip=function(params){
  ...
  //    return params.name;
   ...
   //  for(var i=1;i<option.series.length;){
  //      if(params.seriesIndex==i){
   //        for(var j=0;j<tip.length;j++){
   ////         if(params.name==tip[j][0].name){
   //          res=tip[j][1].name;
   //         }else{
   //         res=params.name;
   //         }
  ...
  //   }
    ...
    tooltip :      {
        trigger: 'item',
        formatter:  '{b}:{a}'              // function(params){
          //  var res='';
 
     //     for(var i=0;i<tip.length;i++){
        
       //    alert(tootip[i][0].name);
   //        if(params.name==tip[i][0].name){
   //          res=tip[i][1].name;
       //      break;
