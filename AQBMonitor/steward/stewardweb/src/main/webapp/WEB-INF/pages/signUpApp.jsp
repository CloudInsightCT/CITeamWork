        ...
        <div class="errorwrapper error403">
            <div class="errorcontent">
                ...
                <div class="profile_about">
                    ...
                    <p>以Tomcat为例，可以将上面三个参数加入到Tomcat的启动脚本<code>在linux系统中catalina.sh</code>中：</p>
                    ...
                    <p><code>windows系统中catalina.cat</code>中：</p>
                ...
                <div class="profile_about">
                	<p>上述步骤确认完成后，将第三步使用的ApplicationName填入下方，将默认的tomcat修改成您自己的应用名称，然后点击“注册”按钮，向服务器注册新接入的应用</p>
                	<p>例如您可以定义应用名称为Baidu，则ApplicationName:<code>${uuidstr_short}-BaiDu</code></p>
                    <p><input  type="text" id="input_appname" value="${uuidstr_short}-tomcat" /></code> <button id="btn_signup" onclick="signupapp()" class="stdbtn btn_orange">注册</button></p>
